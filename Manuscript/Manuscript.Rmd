...
```{r, Figure-1, ref.label = "fig1", echo = FALSE, message = FALSE, fig.height=3, fig.width=6, fig.align='center', fig.cap='Field research locations in the United States north central region.', out.width = "160mm", out.height = "90mm"}
