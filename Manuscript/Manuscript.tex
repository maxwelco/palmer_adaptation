...
five locations: Arlington, WI, Clay Center, NE,, Grant, NE, Lincoln, NE,
and Macomb, IL.
...
2019 (Correndo et al., 2021) (Figure 2).
...
Bareground &  &  &  &  &  & \\
 ...
 & Weed control\textsuperscript{a} & \emph{S}-metolachor\textsuperscript{b} fb glyphosate\textsuperscript{c}  & saflufenacil + imazethapyr + pyroxasulfone\textsuperscript{d} & glyphosate\textsuperscript{c} & glyphosate + \emph{S}-metolachor\textsuperscript{f} fb glyphosate\textsuperscript{g} & glyphosate + \emph{S}-metolachor\textsuperscript{f} \\
...
Corn &  &  &  &  &  & \\
 ...
 & Weed control & \emph{S}-metolachor fb glyphosate & \emph{S}-metolachlor + trazine + mesotrione + bicyclopyrone\textsuperscript{e} & glyphosate & glyphosate + \emph{S}-metolachor\textsuperscript{f} fb glyphosate\textsuperscript{g} & glyphosate + \emph{S}-metolachor \\
...
version 4.0.1 (R Core Team, 2021).
...
observed for weight (Figure 6B) and height (Figure 6C), where the
...
architecture in competing for light (Figure 7), where plants growing in
...
abundance of light, nutrient and water resources (Figure 4A, 3B). These
...
North Central United States cropping systems.
...
R Core Team (2021). \emph{R: {The R Project} for {Statistical
...
\caption{Field research locations in the United States North Central region.}\label{fig:Figure-1}
\end{figure}
...
{\centering \includegraphics[width=150mm,height=90mm]{../data analysis/figures/Figure 7} 

}

\caption{MCO (first manuscript author, 180 cm) holds harvested Palmer amaranth plants at 40 days after first cohort transplanting (A) and 33 days after second cohort transplanting (B) time. From left to right in each image, Palmer amaranth growing in bareground, soybean and corn in Arlington, Wisconsin.}\label{fig:Figure-7}
\end{figure}
