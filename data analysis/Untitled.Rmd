...
(mainland <- ggplot(data = usa) +
    ...
    geom_sf(data = sites, size = 3, shape = c(15, 16, 17, 18, 19)) +
...
mainland +
 ...
 # geom_sf_text(data = sites, aes(label = location))

ggsave("figures/map.png", width = 7, heigh = 4)
```
...
ggdraw(mainland) +
    ...
    draw_plot(hawaii, width = 0.15, height = 0.15 * 10/6 * ratioHawaii, 
        x = 0.3, y = 0.05) +
  annotate("text", label = "Arlington, WI", x = 90, y = 40)
```
